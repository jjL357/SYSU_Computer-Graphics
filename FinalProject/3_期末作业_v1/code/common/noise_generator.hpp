...
public:
   ...
   void setup(unsigned int noise_start_seg, unsigned int noise_levels, float noise_start_factor, float noise_factor, Noise_Function_select noise){
...
protected:
   ...
   float function_recurs_noise(float x, float y){
      ...
      for (unsigned int i = 0; i < noise_levels; i++){
